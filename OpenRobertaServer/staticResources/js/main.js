require.config({
    ...
    paths: {
        ...
        'colorpicker': 'libs/color-picker/color-picker.min',
...
require(['require', 'colorpicker', 'wrap', 'log','jquery', 'blockly', 'guiState.controller', 'progList.controller', 'logList.controller', 'confList.controller',
